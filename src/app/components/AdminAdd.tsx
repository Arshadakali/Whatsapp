...
export function AdminAdd({ onAdminCreated, onBackToAdminLogin }: AdminAddProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.message === 'email_exists') {
        setErrors(prev => ({ ...prev, email: 'Email already exists in database' }));
      } else {
        setErrors(prev => ({ ...prev, form: 'Failed to create admin' }));
      }
    } finally {
      setLoading(false);
    }
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl shadow-slate-500/10 p-8 border border-white/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pl-10 pr-3 py-3 border ${errors.name ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pl-10 pr-3 py-3 border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pl-10 pr-10 py-3 border ${errors.password ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent`}
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pl-10 pr-10 py-3 border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent`}
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-slate-700 to-gray-800 text-white font-bold py-3 px-4 rounded-xl hover:from-slate-800 hover:to-gray-900 transform transition-all duration-200 hover:scale-[1.02] shadow-lg shadow-slate-500/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
